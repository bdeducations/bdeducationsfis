...
<section class="content-header">
    <h1 class="left-main-heading-breadcum">Create New Area</h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <!-- form start -->
                <form role="form" method="POST" class="form-horizontal" action="{{ url('/') }}/areas/store" >
                    {!! csrf_field() !!}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="title" class="form-control" id="area_name" placeholder="Name" required="required" />
                                    </div>
                                </div>
                                 <div class="form-group">
                                     <label for="area_code" class="col-md-2 control-label">Code </label>
                                    <div class="col-md-10">
                                        <input type="text" name="area_code" class="form-control" id="area_code" placeholder="Code"  />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="area_description" class="col-md-2 control-label">Description</label>
                                    <div class="col-md-10">
                                        <textarea class="form-control" name="description" id="area_description" rows="3" placeholder="Description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
