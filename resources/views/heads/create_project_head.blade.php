...
<section class="content-header">
    <h1 class="left-main-heading-breadcum">Create New Project Head</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Add Project Head</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <!-- form start -->
                <form role="form" method="POST" class="form-horizontal" action="{{ url('/') }}/budget/project/head/store" >
                    {!! csrf_field() !!}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="budget_year" class ="form-control" required="required">
                                            <option selected="selected" readonly="readonly" value="<?php echo date('Y'); ?>"><?php echo date('Y'); ?></option> 
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
