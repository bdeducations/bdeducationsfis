...
<section class="content-header">
    <h1 class="left-main-heading-breadcum">Manage Project Head</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Project Head List</li>
    </ol>
</section>
<!-- Main content -->
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Project Head List</h3>
                    <a href="{{ url('/') }}/budget/project/head/create">
                        <button type="button" class="btn btn-primary pull-right" style="margin-right: 5px;">
                            <i class="fa fa-plus"></i> Add New Project Head
                        </button>
                    </a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="UT_budget_project_head_list" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Head Name</th>
                                ...
                                ?>>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php if ($row->has_child == 0): ?>
                                            <?php if ($row->status == 1): ?>
                                                <a onclick="return confirm('Are you sure to Inactive the budget head: <?php echo $row->title; ?>')" href="{{ url('/') }}/budget/project/head/delete/{{ $row->head_row_id }}"> | Inactive</a>
                                            <?php else: ?>
                                                <a onclick="return confirm('Are you sure to Active the budget head: <?php echo $row->title; ?>')" href="{{ url('/') }}/budget/project/head/delete/{{ $row->head_row_id }}"> | Active</a>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#UT_budget_project_head_list').DataTable({
            paging: true,
