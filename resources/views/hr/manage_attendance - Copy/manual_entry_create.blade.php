            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase"> Manual Attendance </span>
                    </div>
                    <div class="actions">
                    </div>
                </div>
                <div class="portlet-body form">
                    <form role="form" method="post" action="{{ url('/') }}/schoolAdmin/attendance/studentsList" >
                        {!! csrf_field() !!}
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn blue hidden_submit_btn" disabled="disabled">Get Student Lists</button>
                        </div>
                    </form>
