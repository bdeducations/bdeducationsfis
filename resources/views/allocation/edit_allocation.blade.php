...
<section class="content-header">
    <h1 class="left-main-heading-breadcum">Update Budget Allocation</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Update Allocation</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <!-- form start -->
                <form role="form" method="POST" class="form-horizontal" action="{{ url('/') }}/allocation/update/{{ $allocation_row_detail->allocation_row_id }}" >
                    {!! csrf_field() !!}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-10">
                                        <select name="budget_year" class="ut_budget_year form-control" required="required">>
                                            ...
                                            <?php foreach ($year_array as $key => $value): ?>
                                                <option <?php
                                            if ($key == $allocation_row_detail->budget_year): echo "selected='selected'";
                                            endif;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="area_row_id" class="form-control" required="required">>
                                            ...
                                            <option <?php
                                            if ($area_row->area_row_id == $allocation_row_detail->area_row_id): echo "selected='selected'";
                                            endif;
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <select name="head_row_id"  id="budget_edit_allocation_head_dropdown" class="ut_budget_head_drop_down form-control" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="amount" class="form-control" id="amount" value="<?php echo isset($allocation_row_detail->amount) ? $allocation_row_detail->amount : ''; ?>" placeholder="Amount" required="required" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="allocation_remarks" class="col-md-2 control-label">Description</label>
                                    <div class="col-md-10">
                                        <textarea class="form-control" name="remarks" id="allocation_remarks" rows="3" placeholder="Description"><?php echo isset($allocation_row_detail->remarks) ? $allocation_row_detail->remarks : ''; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#budget_edit_allocation_head_dropdown").change(function(){
        ...
        $(".ut_budget_year").change(function(){
            ...
            var selected_head_row_id = <?php echo isset($allocation_row_detail->head_row_id)? $allocation_row_detail->head_row_id: "null" ?>;
