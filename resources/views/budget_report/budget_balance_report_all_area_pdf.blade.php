    ...
    <body>
        <div class="pdfcontent" style="text-align:center;">
            <div style="margin-bottom:5px;">
                <h4 style="margin:0;padding:0;">Budget Balance Report : <?php echo $data['selected_budget_year']; ?></h4>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;padding-left:7px">
                            @if(isset($area_expense_row['total_allocation']) && ($area_expense_row['total_allocation'] != 0) && ($area_expense_row['has_child'] == 0))
                            {{ number_format($area_expense_row['total_allocation'], 2) }}
                            @elseif(isset($area_expense_row['total_allocation']) && ($area_expense_row['total_allocation'] == 0) && ($area_expense_row['has_child'] == 0))
                            0.00
                            @endif
                        </td>
                        <td style="text-align:center;padding-left:7px">
                        ...
                        <td style="text-align:center;padding-left:7px">
                            @if(isset($area_expense_row['head_current_balance']) && ($area_expense_row['head_current_balance'] != 0) && ($area_expense_row['has_child'] == 0))
                            {{ number_format($area_expense_row['head_current_balance'], 2) }}
                            @elseif(isset($area_expense_row['head_current_balance']) && ($area_expense_row['head_current_balance'] == 0) && ($area_expense_row['has_child'] == 0))
                            0.00
                            @endif
                        </td>
                    </tr>
            ...
            @endif
            <?php ++$area_counter;$parent_serial = 1;?>
            @endforeach
            <?php if (($data['selected_head_row_id'] == -1) && ($data['selected_area_row_id'] == -1)): ?>
