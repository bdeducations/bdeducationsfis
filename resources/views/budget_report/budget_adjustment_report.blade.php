...
<section class="content-header">
    <h1 class="left-main-heading-breadcum">Budget Adjustment Report</h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                <!-- form start -->
                <form role="form" method="POST" class="form-horizontal" action="{{ url('/') }}/budget/adjustment/report" >
                    {!! csrf_field() !!}
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                ...
                <div class="box-header">
                    <a target="_blank" class="btn btn-default" href="{{ url('/') }}/budget/adjustment/report/download?head_row_id={{ $data['selected_head_row_id'] }}@if($pdf_area_qstring){{ $pdf_area_qstring }}@endif @if($pdf_date_qstring){{ $pdf_date_qstring }}@endif"><i class="fa fa-download"></i><strong> Download Report PDF</strong></a>
                    <a target="_blank" class="btn btn-default" style="margin-left:15px;" href="{{ url('/') }}/budget/adjustment/report/downloadCSV?head_row_id={{ $data['selected_head_row_id'] }}@if($pdf_area_qstring){{ $pdf_area_qstring }}@endif @if($pdf_date_qstring){{ $pdf_date_qstring }}@endif"><i class="fa fa-download"></i><strong> Download Report CSV</strong></a>
                </div>
                @endif
                <div class="box-body">
                    @if($data['account_adjustment_list'])
                    ...
                    @else
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="UT_budget_report_balance_extended">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="3" style="text-align:center"><strong style="text-align:center">No Budget Allocation Adjustment Data Found</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    @endif
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#UT_budget_adjustment_report').DataTable({
            paging: true,
