        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <div class="box-header">
                    <a target="_blank" class="btn btn-default" href="{{ url('/') }}/budgetReport/expenseReportExtendedDownload?head_row_id={{ $data['selected_head_row_id'] }}@if($pdf_area_qstring){{ $pdf_area_qstring }}@endif @if($pdf_date_qstring){{ $pdf_date_qstring }}@endif"><i class="fa fa-download"></i><strong> Download Report PDF</strong></a>
                    <a target="_blank" style="margin-left:15px;" class="btn btn-default" href="{{ url('/') }}/budgetReport/expenseReportExtendedCSVDownload?head_row_id={{ $data['selected_head_row_id'] }}@if($pdf_area_qstring){{ $pdf_area_qstring }}@endif @if($pdf_date_qstring){{ $pdf_date_qstring }}@endif"><i class="fa fa-download"></i><strong> Download Report CSV</strong></a>
                </div>
                @endif
                <div class="box-body">
                    <h3 style="text-transform:uppercase;text-align:center;"> {{ $data['area_row_title'] }}</h3>
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="UT_budget_report_expense_extended">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;padding-left:10px">
                                    ...
                                    ?>
                                    @if(isset($expense_row->total_expense))
                                    <a target="_blank" href="{{ url('/') }}/budgetReport/expenseReportDetails?head_row_id={{ $expense_row->head_row_id }}@if($area_qstring){{ $area_qstring }}@endif @if($date_qstring){{ $date_qstring }}@endif">Details</a>
                                    @endif
                                </td>
                            </tr>
                            ...
                            @else
                                <tr>
                                    <td colspan="3" style="text-align: center;">
                                        <strong style="text-align:center">No Budget Expense Data Found</strong>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
