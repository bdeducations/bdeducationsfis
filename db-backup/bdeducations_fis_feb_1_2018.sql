...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2018 at 06:30 AM
...
(1, 'Admin', 'info@bdeducations.org', '$2y$10$acD1ZNIRWRqSW0OItBD3Su5HQtBgI4ydNwKnsE4P.Q/CT64/FZ8wq', 'NifeHV3SmlMRTJy6M0lcQqyWXI8CIIMAOKEmVYZjTTl9zzubojLqjkflJRMV', '2017-02-13 03:31:59', '2017-02-13 03:31:59');
...
--
ALTER TABLE `ut_heads`
  MODIFY `head_row_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `ut_staff_attendance_records`
  MODIFY `attendance_record_row_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2259;
